...
const han_result = document.getElementById('han_result');
const ten_result = document.getElementById('ten_result');
const tsumo_result = document.getElementById('tsumo_result');
...
function removeDisabled(y) {    // クラス"disabled"を除去
...
document.getElementById('calculation').addEventListener('click', function () {
  ...
  if (document.getElementById('q3-yes').checked === true || document.getElementById('q4-yes').checked === true) {
    ...
    kan_fu = ankan1Count * 30 + ankan2Count * 20 + minkan1Count * 20 + minkan2Count * 10;
    fu_su += kan_fu;
  }
