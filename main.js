...
q1.addEventListener('change', function () {
  ...
  else if (document.getElementById('q1-no').checked === true) {
...
q3.addEventListener('change', function () {
  ...
  else if (document.getElementById('q3-no').checked === true) {
...
q4.addEventListener('change', function () {
  ...
  else if (document.getElementById('q4-no').checked === true) {
    kan.classList.remove('disabled');
  }
});
